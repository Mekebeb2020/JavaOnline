...
public class Lesson5 {
   ...
   long value5 = 4_568_987_367_367L;
   ...
   // This method shows a local variable
    public void showLocalExample() {
       ...
       // this methods has 2 parameters separated by comma
        public void showLocalWithParameter(int able, int vals){
         int total = able + vals;
         System.out.println(total);
        }

        // This methods has 2 parameters and a return type
    public int showLocalWithReturn(int type1 , int type2){
        return type1 + type2;
    }

    // Methods show Instance variable that changes value inside the method
